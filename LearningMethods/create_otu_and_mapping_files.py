...
class CreateOtuAndMappingFiles(object):
    ...
    def preprocess(self, preprocess_params, visualize, taxonomy_col="taxonomy"):
        # print('preprocess...')
        ...
        self.otu_features_df, self.otu_features_df_b_pca, self.pca_ocj, self.bacteria, self.pca_comp = preprocess_data(
            self.otu_features_df, preprocess_params, self.tags_df, visualize_data=visualize, taxonomy_col=taxonomy_col)
