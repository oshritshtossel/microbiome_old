...
otu = 'C:/Users/Anna/Documents/gdm_otu.csv'
mapping = 'C:/Users/Anna/Documents/mapping_gdm_gut.csv'
...
mer_data = preproccessed_data.join(OtuMf.mapping_file['disease'],  how='inner')
print(mer_data.shape)
visualize_pca(mer_data.loc[:, mer_data.columns != 'disease'])
